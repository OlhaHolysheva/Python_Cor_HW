...
player_image = pygame.image.load(r"C:\Users\hp\Desktop\Python\game_py\fly.jpg").convert()
...
#повертає поточну позицію мишки на екрані
    ...
    screen.fill((0,0,0)) #щоб картинка не копіювалась, а пересувалась по екрану
